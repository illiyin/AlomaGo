...
<html lang="en">
  <head>
    ...
    <link href="<?= resources_url(); ?>build/css/styles.css" rel="stylesheet">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?= @$this->admindata->foto_profil ?>" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?= @$this->admindata->nama ?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
